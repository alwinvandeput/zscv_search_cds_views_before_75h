...
@AbapCatalog.sqlViewName: 'ZSCV2_CDSVW'
...
define view ZSCV2_CdsView
  ...
  association [0..1] to ZSCV2_CdsViewReleaseStatus   as _Status          on _Status.ViewName = $projection.DdlSourceName

  association [0..1] to ddheadanno                  as _Annotation      on _Annotation.strucobjn = $projection.DdlSourceName
  association [0..1] to ZSCV2_CdsViewServiceDefCount as _ServiceDefCount on _ServiceDefCount.DdlSourceName = $projection.DdlSourceName
{
