...
@AbapCatalog.sqlViewName: 'ZSCV2_ABAP_CHILD'

@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED

define view ZSCV2_AbapViewChild2
  with parameters
    p_DdicCdsBasedOnDllResourceInd :abap_boolean

  as

  select from ZSCV2_DdicViewChildDdicView as DdicViewParentChildRelation
{
...
select from ZSCV2_CdsViewChildCdsView as CdsViewParentChildRelation
{
