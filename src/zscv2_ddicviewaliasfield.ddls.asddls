@AbapCatalog.sqlViewName: 'ZSCV2_DDVWALFLD'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'DDic View Field'
define view ZSCV2_DdicViewAliasField
  as

  select from  dd03l          as Field
    inner join ZSCV2_DdicView as DDicView on DDicView.Dd25lViewName = Field.tabname
{
