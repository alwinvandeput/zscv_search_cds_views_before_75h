...
@AbapCatalog.sqlViewName: 'ZSCV_DDVWDBTAB'

@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED

define view ZSCV2_DdicViewByDbTable
  with parameters
    p_DbTableName :vibastab

  as select from ZSCV2_DdicViewHier(p_DbTableName: $parameters.p_DbTableName) as DdicViewHier
  association [0..1] to ZSCV2_CdsView as _CdsView         on  _CdsView.DdicViewName = DdicViewHier.ParentViewName
